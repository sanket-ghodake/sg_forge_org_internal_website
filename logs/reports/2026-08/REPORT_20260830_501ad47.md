...
- **Commit**: `501ad47` (`501ad47ff985a07ebe72546bc967c8114d66bab1`)
- **Timestamp**: `2026-08-30 21:53` (`2026-08-30T21:53:48+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `orchestration`
- **Subject**: `implement docker compose profiles, graceful SIGTERM WAL checkpoints, declarative K8s manifests, and context-isolated dockerfiles`
...
```
feat(orchestration): implement docker compose profiles, graceful SIGTERM WAL checkpoints, declarative K8s manifests, and context-isolated dockerfiles
```
...
- **Total Insertions (+)**: `+2644`
- **Total Deletions (-)**: `-1050`
- **Affected Subsystems**: `auth`, `dev-dashboard`, `dev-hub`, `landing`, `portal`, `docker-infra`, `app-template`, `billing`, `expenses`, `telemetry`

---

## 🗂️ Detailed File Changes (44 Files)
...
| 🟢 Added | `deploy/README.md` |
| 🟢 Added | `deploy/k8s/README.md` |
| 🟢 Added | `deploy/k8s/base/README.md` |
| 🟢 Added | `deploy/k8s/base/app-billing.yaml` |
| 🟢 Added | `deploy/k8s/base/app-expenses.yaml` |
| 🟢 Added | `deploy/k8s/base/app-telemetry.yaml` |
| 🟢 Added | `deploy/k8s/base/auth.yaml` |
| 🟢 Added | `deploy/k8s/base/caddy-gateway.yaml` |
| 🟢 Added | `deploy/k8s/base/dev-dashboard.yaml` |
| 🟢 Added | `deploy/k8s/base/dev-hub.yaml` |
| 🟢 Added | `deploy/k8s/base/kustomization.yaml` |
| 🟢 Added | `deploy/k8s/base/landing.yaml` |
| 🟢 Added | `deploy/k8s/base/portal.yaml` |
| 🟢 Added | `deploy/k8s/overlays/README.md` |
| 🟢 Added | `deploy/k8s/overlays/dev/README.md` |
| 🟢 Added | `deploy/k8s/overlays/dev/kustomization.yaml` |
| 🟢 Added | `deploy/k8s/overlays/prod/README.md` |
| 🟢 Added | `deploy/k8s/overlays/prod/kustomization.yaml` |
