...
- **Commit**: `38943f4` (`38943f49de7762099ed2a30045262dd61691aa8b`)
- **Timestamp**: `2026-08-30 23:08` (`2026-08-30T23:08:52+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `observability`
- **Subject**: `implement centralized microservice logging, PII redaction, RFC 7807 trace correlation, and frontend console hardening`
...
```
feat(observability): implement centralized microservice logging, PII redaction, RFC 7807 trace correlation, and frontend console hardening
```
...
- **Total Insertions (+)**: `+539`
- **Total Deletions (-)**: `-222`
- **Affected Subsystems**: `auth`, `portal`, `sdk`, `toolchain`
...
| 🟡 Modified | `.agents/rules/observability.md` |
...
| 🟡 Modified | `apps/test/unit/sdk.test.ts` |
