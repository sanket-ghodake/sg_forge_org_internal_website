...
- **Commit**: `679cee7` (`679cee7c9cc614541cb138dc484d89f660099d85`)
- **Timestamp**: `2026-09-02 03:58` (`2026-09-02T03:58:56+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `docs`
- **Subject**: `update root and all microservice readmes with toolchain code metrics matrices`
...
```
docs: update root and all microservice readmes with toolchain code metrics matrices
```
...
- **Total Insertions (+)**: `+3578`
- **Total Deletions (-)**: `-856`
- **Affected Subsystems**: `README.md`, `auth`, `dev-dashboard`, `dev-hub`, `landing`, `portal`, `sdk`, `types`, `ui`, `app-template`, `billing`, `expenses`, `telemetry`
...
| :--- | :--- |
| 🟡 Modified | `README.md` |
| 🟡 Modified | `apps/src/README.md` |
| 🟡 Modified | `apps/src/auth/README.md` |
| 🟡 Modified | `apps/src/dev-dashboard/README.md` |
| 🟡 Modified | `apps/src/dev-hub/README.md` |
| 🟡 Modified | `apps/src/landing/README.md` |
| 🟡 Modified | `apps/src/portal/README.md` |
| 🟡 Modified | `apps/src/sdk/README.md` |
| 🟡 Modified | `apps/src/types/README.md` |
| 🟡 Modified | `apps/src/ui/README.md` |
| 🟡 Modified | `forge-apps/README.md` |
| 🟢 Added | `forge-apps/app-template/README.md` |
| 🟡 Modified | `forge-apps/billing/README.md` |
| 🟡 Modified | `forge-apps/expenses/README.md` |
| 🟡 Modified | `forge-apps/telemetry/README.md` |
