...
- **Commit**: `36229c2` (`36229c29ae35eaf99dc6a7ab0a6b8e292d972fdf`)
- **Timestamp**: `2026-09-03 13:01` (`2026-09-03T13:01:46+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `ci`
- **Subject**: `consolidate github actions into single manual DAG pipeline with step-by-step nodes`
...
```
feat(ci): consolidate github actions into single manual DAG pipeline with step-by-step nodes
```
...
| 🟢 Added | `.github/workflows/pipeline.yml` |
| 🔴 Deleted | `.github/workflows/sbom-audit.yml` |
