...
- **Commit**: `c455cf7` (`c455cf79d9d44480bdbd272a8507c6139932c73c`)
- **Timestamp**: `2026-09-01 16:00` (`2026-09-01T16:00:51+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `dev-dashboard`
- **Subject**: `add MS Teams org chart search, clean department dropdowns, and implement 4-tier state persistence`
...
```
feat(dev-dashboard): add MS Teams org chart search, clean department dropdowns, and implement 4-tier state persistence
```
...
- **Total Insertions (+)**: `+3090`
- **Total Deletions (-)**: `-1034`
- **Affected Subsystems**: `auth`, `dev-dashboard`, `ui`
...
| 🟡 Modified | `apps/src/auth/test/unit/hierarchy.test.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/frontend/ui-employee-drawer-scripts.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/frontend/ui-employee-import-scripts.ts` |
...
| 🟢 Added | `apps/src/dev-dashboard/test/unit/employee-state-persistence.test.ts` |
