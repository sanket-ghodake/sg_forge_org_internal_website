...
- **Commit**: `9fe8c52` (`9fe8c52625004ad44320de6f38f7b218a3f3b6eb`)
- **Timestamp**: `2026-09-03 12:52` (`2026-09-03T12:52:31+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `toolchain`
- **Subject**: `integrate 14 portable open-source tools with zero host modification and 21 quality gates`
...
```
feat(toolchain): integrate 14 portable open-source tools with zero host modification and 21 quality gates
```
...
- **Total Insertions (+)**: `+2191`
- **Total Deletions (-)**: `-66`
- **Affected Subsystems**: `ui`, `toolchain`
...
| 🟢 Added | `portables/bin/axe` |
| 🟢 Added | `portables/bin/ctop` |
| 🟢 Added | `portables/bin/depcruise` |
| 🟢 Added | `portables/bin/k6` |
| 🟢 Added | `portables/bin/lhci` |
| 🟢 Added | `portables/bin/madge` |
| 🟢 Added | `portables/bin/osv-scanner` |
| 🟢 Added | `portables/bin/schemathesis` |
| 🟢 Added | `portables/bin/semgrep` |
| 🟢 Added | `portables/bin/shellcheck` |
| 🟢 Added | `portables/bin/spectral` |
| 🟢 Added | `portables/bin/syft` |
| 🟢 Added | `portables/bin/trivy` |
| 🟢 Added | `portables/bin/type-coverage` |
| 🟡 Modified | `run.sh` |
| 🟢 Added | `scripts/verify-checks.ts` |
