...
- **Commit**: `f700f8d` (`f700f8d8017f6e5e6f174a52c7c49e5ab4abb5f4`)
- **Timestamp**: `2026-09-01 07:35` (`2026-09-01T07:35:56+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `dev-dashboard`
- **Subject**: `unified Database Studio, Supabase-grade design tokens, sleep/wake auto-recovery, and autofill decoupling`
...
```
feat(dev-dashboard): unified Database Studio, Supabase-grade design tokens, sleep/wake auto-recovery, and autofill decoupling
```
...
| Action | File Path |
| :--- | :--- |
| 🟡 Modified | `apps/src/dev-dashboard/README.md` |
...
| 🟢 Added | `apps/src/dev-dashboard/src/db/remote-connectors.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/frontend/ui-log-scripts.ts` |
| 🟢 Added | `apps/src/dev-dashboard/src/frontend/ui-modals.ts` |
...
| 🟢 Added | `apps/src/dev-dashboard/test/unit/remote-connectors.test.ts` |
| 🟢 Added | `apps/src/dev-dashboard/test/unit/stream-resilience.test.ts` |
| 🟢 Added | `apps/src/ui/src/icons.ts` |
| 🟡 Modified | `apps/src/ui/src/index.ts` |
| 🟡 Modified | `apps/src/ui/src/styles/base.ts` |
| 🟡 Modified | `apps/src/ui/src/styles/components.ts` |
| 🟡 Modified | `apps/src/ui/src/tokens.ts` |
