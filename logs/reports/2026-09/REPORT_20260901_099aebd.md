...
- **Commit**: `099aebd` (`099aebdfb0386c164ba1b7ca7e47951f1b6c555f`)
- **Timestamp**: `2026-09-01 19:57` (`2026-09-01T19:57:22+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `fix` | **Scope**: `dev-dashboard`
- **Subject**: `align telemetry log source and harden precommit verification gate`
...
```
fix(dev-dashboard): align telemetry log source and harden precommit verification gate
```
...
- **Total Insertions (+)**: `+13`
- **Total Deletions (-)**: `-6`
- **Affected Subsystems**: `dev-dashboard`, `portal`, `toolchain`

---

## 🗂️ Detailed File Changes (4 Files)
