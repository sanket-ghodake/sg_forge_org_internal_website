...
- **Commit**: `2700a63` (`2700a63bd0821d23b9a75b81fa235d3ad40b6b41`)
- **Timestamp**: `2026-09-01 22:51` (`2026-09-01T22:51:04+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `portal`
- **Subject**: `redesign Apps & Tools Hub for Forge apps and remove People Directory view`
...
```
feat(portal): redesign Apps & Tools Hub for Forge apps and remove People Directory view
```
...
| 🟢 Added | `apps/src/portal/src/frontend/ui-apps-data.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-apps-scripts.ts` |
| 🟡 Modified | `apps/src/portal/src/frontend/ui-command-palette.ts` |
| 🔴 Deleted | `apps/src/portal/src/frontend/ui-directory-scripts.ts` |
| 🟡 Modified | `apps/src/portal/src/frontend/ui-modals.ts` |
| 🟡 Modified | `apps/src/portal/src/frontend/ui-renderer-apps.ts` |
| 🔴 Deleted | `apps/src/portal/src/frontend/ui-renderer-directory.ts` |
