...
- **Commit**: `77fdd07` (`77fdd0775fa9d08fa30aff4e4b4dad2aa87f5435`)
- **Timestamp**: `2026-09-04 21:10` (`2026-09-04T21:10:15+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `fix` | **Scope**: `prod`
- **Subject**: `resolve db volume permissions and add organization deployment guide`
...
```
fix(prod): resolve db volume permissions and add organization deployment guide
```
...
- **Total Deletions (-)**: `-0`
- **Affected Subsystems**: `docker-infra`
...
| 🟢 Added | `docs/ORGANIZATION_DEPLOYMENT_AND_QUICKSTART_GUIDE.md` |
