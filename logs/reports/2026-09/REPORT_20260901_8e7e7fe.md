...
- **Commit**: `8e7e7fe` (`8e7e7fead57c41ce8ceb56b223ad02b6ecd21324`)
- **Timestamp**: `2026-09-01 22:13` (`2026-09-01T22:13:47+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `portal`
- **Subject**: `redesign company map & org canvas with employee-focused progressive tree, fixed minimap, and supabase craft standard`
...
```
feat(portal): redesign company map & org canvas with employee-focused progressive tree, fixed minimap, and supabase craft standard
```
...
- **Total Insertions (+)**: `+11394`
- **Total Deletions (-)**: `-3396`
- **Affected Subsystems**: `dev-dashboard`, `portal`
...
| 🟢 Added | `apps/src/portal/src/frontend/ui-canvas-inspector.ts` |
| 🟡 Modified | `apps/src/portal/src/frontend/ui-canvas-scripts.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-canvas-views.ts` |
