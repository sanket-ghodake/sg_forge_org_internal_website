...
- **Commit**: `0ff51b1` (`0ff51b1104ce3d8301914284460d19c9fe24cf03`)
- **Timestamp**: `2026-09-01 16:51` (`2026-09-01T16:51:02+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `dev-dashboard`
- **Subject**: `reposition side drawers below header and add drag-to-resize handles without backdrop blur`
...
```
feat(dev-dashboard): reposition side drawers below header and add drag-to-resize handles without backdrop blur
```
