...
- **Commit**: `c51619d` (`c51619d01ca15ffd2f6f0e0cffd10f528d62cc2c`)
- **Timestamp**: `2026-09-01 21:54` (`2026-09-01T21:54:30+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `dashboard`
- **Subject**: `implement single session auth and default org personas`
...
```
feat(dashboard): implement single session auth and default org personas
```
...
- **Total Insertions (+)**: `+1155`
- **Total Deletions (-)**: `-137`
- **Affected Subsystems**: `auth`, `dev-dashboard`
...
| 🟢 Added | `apps/src/auth/test/unit/default-personas.test.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/backend/api-handlers.ts` |
| 🟢 Added | `apps/src/dev-dashboard/src/backend/auth-session.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/backend/employee-controller.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/frontend/index.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/frontend/ui-modals.ts` |
| 🟢 Added | `apps/src/dev-dashboard/src/frontend/ui-renderer-login.ts` |
...
| 🟡 Modified | `apps/src/dev-dashboard/test/e2e/apps-command-center-journey.test.ts` |
...
| 🟢 Added | `apps/src/dev-dashboard/test/security/dashboard-auth.test.ts` |
