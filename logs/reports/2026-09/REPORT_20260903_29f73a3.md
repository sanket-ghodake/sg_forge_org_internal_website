...
- **Commit**: `29f73a3` (`29f73a3514752e6751e1735684c07d36b2b7ae0e`)
- **Timestamp**: `2026-09-03 09:56` (`2026-09-03T09:56:54+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `database`
- **Subject**: `enforce test DB isolation, prevent dev wipes, and add reset-db CLI`
...
```
feat(database): enforce test DB isolation, prevent dev wipes, and add reset-db CLI
```
...
- **Total Deletions (-)**: `-429`
- **Affected Subsystems**: `auth`, `sdk`, `toolchain`
