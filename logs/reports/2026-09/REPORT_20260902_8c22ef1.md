...
- **Commit**: `8c22ef1` (`8c22ef12a9e108d59b1f07ea54cef5e786789957`)
- **Timestamp**: `2026-09-02 03:48` (`2026-09-02T03:48:04+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `auth`
- **Subject**: `implement canonical database manager and test isolation for persistent resets`
...
```
feat(auth): implement canonical database manager and test isolation for persistent resets
```
...
| 🟡 Modified | `apps/src/auth/test/integration/auth-flow.test.ts` |
...
| 🟡 Modified | `apps/src/portal/src/backend/org-tree-service.ts` |
| 🟡 Modified | `apps/src/sdk/README.md` |
| 🟢 Added | `apps/src/sdk/src/database.ts` |
