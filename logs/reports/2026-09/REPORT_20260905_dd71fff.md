...
- **Commit**: `dd71fff` (`dd71fffab284d25f8a0df96aa974f28ed5ed3d9f`)
- **Timestamp**: `2026-09-05 19:05` (`2026-09-05T19:05:07+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `docs`
- **Subject**: `remove legacy idea folder and update documentation links`
...
```
docs: remove legacy idea folder and update documentation links
```
...
- **Total Insertions (+)**: `+19584`
- **Total Deletions (-)**: `-29491`
- **Affected Subsystems**: `core-platform`

---

## 🗂️ Detailed File Changes (18 Files)
...
| 🔴 Deleted | `idea/01_ARCHITECTURE.md` |
| 🔴 Deleted | `idea/02_FORGE_APPS_SPEC.md` |
| 🔴 Deleted | `idea/03_SECURITY_AND_RBAC.md` |
| 🔴 Deleted | `idea/04_TESTING_STRATEGY.md` |
| 🔴 Deleted | `idea/05_DEVELOPER_EXPERIENCE.md` |
| 🔴 Deleted | `idea/README.md` |
| 🔴 Deleted | `idea/assets/app_anatomy_folders_1787245967272.jpg` |
| 🔴 Deleted | `idea/assets/sg_forge_architecture_1787245951704.jpg` |
| 🟡 Modified | `logs/WORKLOGS.md` |
| 🟢 Added | `logs/security/2026-09/AUDIT_20260905_0628_pre-commit.md` |
