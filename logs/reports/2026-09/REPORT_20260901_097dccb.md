...
- **Commit**: `097dccb` (`097dccbd4f7dda68cb5640061a9bd6ace403a6e9`)
- **Timestamp**: `2026-09-01 14:42` (`2026-09-01T14:42:26+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `ui`
- **Subject**: `modernize dropdowns, modals, and toasts with smart viewport collision detection`
...
```
feat(ui): modernize dropdowns, modals, and toasts with smart viewport collision detection
```
...
- **Total Insertions (+)**: `+1108`
- **Total Deletions (-)**: `-340`
- **Affected Subsystems**: `dev-dashboard`, `dev-hub`, `portal`, `ui`
...
| 🟡 Modified | `CLAUDE.md` |
| 🟡 Modified | `GEMINI.md` |
| 🟡 Modified | `apps/src/dev-dashboard/src/frontend/ui-dropdown-scripts.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/frontend/ui-dropdown-styles.ts` |
...
| 🟡 Modified | `apps/src/dev-dashboard/src/frontend/ui-renderer-employees.ts` |
...
| 🟡 Modified | `apps/src/dev-hub/src/frontend/sections/ui-section.ts` |
...
| 🟢 Added | `apps/src/ui/src/dropdown.ts` |
