...
- **Commit**: `d0b515e` (`d0b515e5648bf6175982fe1e07dd22cbec11923b`)
- **Timestamp**: `2026-09-01 11:48` (`2026-09-01T11:48:00+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `sdk`
- **Subject**: `modularize sdk and add hierarchy ingress generator`
...
```
feat(sdk): modularize sdk and add hierarchy ingress generator
```
...
- **Total Insertions (+)**: `+7410`
- **Total Deletions (-)**: `-1837`
- **Affected Subsystems**: `auth`, `dev-dashboard`, `dev-hub`, `sdk`, `types`, `app-template`, `billing`, `expenses`, `telemetry`, `toolchain`

---

## 🗂️ Detailed File Changes (53 Files)

| Action | File Path |
| :--- | :--- |
| 🟡 Modified | `apps/src/auth/src/backend/api-handlers.ts` |
| 🟢 Added | `apps/src/auth/src/backend/hierarchy.ts` |
| 🟡 Modified | `apps/src/auth/src/server.ts` |
| 🟢 Added | `apps/src/auth/test/unit/hierarchy.test.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/db/db.ts` |
| 🟢 Added | `apps/src/dev-hub/src/frontend/hub-view.ts` |
| 🟡 Modified | `apps/src/dev-hub/src/server.ts` |
| 🟡 Modified | `apps/src/sdk/README.md` |
| 🟢 Added | `apps/src/sdk/src/browser-bridge.ts` |
| 🟢 Added | `apps/src/sdk/src/client-bridge.ts` |
| 🟢 Added | `apps/src/sdk/src/directory-client.ts` |
| 🟢 Added | `apps/src/sdk/src/error-handler.ts` |
| 🟡 Modified | `apps/src/sdk/src/index.ts` |
| 🟢 Added | `apps/src/sdk/src/logger.ts` |
| 🟡 Modified | `apps/src/sdk/src/registry.ts` |
| 🟢 Added | `apps/src/sdk/test/contracts/sdk-exports.test.ts` |
| 🟢 Added | `apps/src/sdk/test/integration/python-service-contract.test.ts` |
| 🟢 Added | `apps/src/sdk/test/unit/directory-client.test.ts` |
| 🟢 Added | `apps/src/sdk/test/unit/error-handler.test.ts` |
| 🟢 Added | `apps/src/sdk/test/unit/external-ingress.test.ts` |
| 🟢 Added | `apps/src/sdk/test/unit/logger.test.ts` |
| 🟢 Added | `apps/src/sdk/test/unit/registry.test.ts` |
| 🟡 Modified | `apps/src/types/src/index.ts` |
| 🟢 Added | `forge-apps/app-template/src/README.md` |
| 🟢 Added | `forge-apps/app-template/src/db/README.md` |
| 🟢 Added | `forge-apps/app-template/src/db/index.ts` |
| 🟢 Added | `forge-apps/app-template/src/server.ts` |
| 🟢 Added | `forge-apps/app-template/test/contracts/health-schema.test.ts` |
| 🟢 Added | `forge-apps/app-template/test/e2e/server.test.ts` |
| 🟢 Added | `forge-apps/app-template/test/integration/health.test.ts` |
| 🟢 Added | `forge-apps/app-template/test/security/auth-gate.test.ts` |
| 🟢 Added | `forge-apps/app-template/test/unit/app.test.ts` |
| 🟢 Added | `forge-apps/billing/src/db/README.md` |
| 🟢 Added | `forge-apps/billing/src/db/index.ts` |
| 🟡 Modified | `forge-apps/billing/src/server.ts` |
| 🟡 Modified | `forge-apps/expenses/src/server.ts` |
| 🟢 Added | `forge-apps/telemetry/src/db/README.md` |
| 🟢 Added | `forge-apps/telemetry/src/db/index.ts` |
...
| 🟢 Added | `samples/external-python-service/README.md` |
| 🟢 Added | `samples/external-python-service/main.py` |
| 🟢 Added | `scripts/create-app.ts` |
| 🟡 Modified | `scripts/generate-proxy.ts` |
| 🟢 Added | `scripts/test/README.md` |
| 🟢 Added | `scripts/test/create-app.test.ts` |
