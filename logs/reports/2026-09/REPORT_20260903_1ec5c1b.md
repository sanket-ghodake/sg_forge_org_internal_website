...
- **Commit**: `1ec5c1b` (`1ec5c1bdeb7bd528899b2845d8cda9d734338b8c`)
- **Timestamp**: `2026-09-03 17:03` (`2026-09-03T17:03:11+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `fix` | **Scope**: `database`
- **Subject**: `enforce strict test db isolation, prevent live db mutation, and harden persistence across restarts`
...
```
fix(database): enforce strict test db isolation, prevent live db mutation, and harden persistence across restarts
```
...
- **Total Insertions (+)**: `+1083`
- **Total Deletions (-)**: `-802`
- **Affected Subsystems**: `dev-dashboard`, `portal`, `sdk`, `app-template`, `billing`, `telemetry`, `toolchain`
...
| 🟡 Modified | `apps/src/sdk/src/database.ts` |
| 🟡 Modified | `apps/src/sdk/src/directory-client.ts` |
| 🟡 Modified | `forge-apps/app-template/src/db/index.ts` |
| 🟡 Modified | `forge-apps/billing/src/db/index.ts` |
| 🟡 Modified | `forge-apps/telemetry/src/db/index.ts` |
...
| 🟢 Added | `scripts/clean-leaked-test-data.ts` |
