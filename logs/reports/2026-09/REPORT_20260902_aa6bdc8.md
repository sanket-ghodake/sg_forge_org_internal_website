...
- **Commit**: `aa6bdc8` (`aa6bdc8d0dc094a67319b82377143735ca61f811`)
- **Timestamp**: `2026-09-02 19:59` (`2026-09-02T19:59:49+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `style` | **Scope**: `dev-dashboard`
- **Subject**: `normalize font size and zoom scale to standard Meta Astryx baseline`
...
```
style(dev-dashboard): normalize font size and zoom scale to standard Meta Astryx baseline
```
...
## 🗂️ Detailed File Changes (9 Files)

| Action | File Path |
| :--- | :--- |
| 🟡 Modified | `apps/src/dev-dashboard/src/README.md` |
| 🟡 Modified | `apps/src/dev-dashboard/src/frontend/README.md` |
