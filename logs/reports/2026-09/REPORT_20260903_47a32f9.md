...
- **Commit**: `47a32f9` (`47a32f964e057a9904a8c7165720c5678d4b1a02`)
- **Timestamp**: `2026-09-03 18:32` (`2026-09-03T18:32:05+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `fix` | **Scope**: `ci`
- **Subject**: `add db initialization to pipeline, fix trivy docker path, and make sbom idempotent`
...
```
fix(ci): add db initialization to pipeline, fix trivy docker path, and make sbom idempotent
```
