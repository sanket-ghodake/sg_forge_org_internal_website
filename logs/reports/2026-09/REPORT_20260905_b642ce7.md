...
- **Commit**: `b642ce7` (`b642ce754a34f762656c194b11c3c87ebb8ccf60`)
- **Timestamp**: `2026-09-05 20:33` (`2026-09-05T20:33:07+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `ingress`
- **Subject**: `add independent ENABLE_HTTP and ENABLE_HTTPS controls and fix proxy TLS conflict`
...
```
feat(ingress): add independent ENABLE_HTTP and ENABLE_HTTPS controls and fix proxy TLS conflict
```
...
| 🟢 Added | `apps/test/unit/ingress-protocols.test.ts` |
...
| 🟢 Added | `logs/security/2026-09/AUDIT_20260905_1432_pre-commit.md` |
| 🟢 Added | `logs/security/2026-09/AUDIT_20260905_1433_commit.md` |
| 🟢 Added | `logs/security/2026-09/AUDIT_20260905_1447_commit.md` |
| 🟢 Added | `logs/security/2026-09/AUDIT_20260905_1502_pre-commit.md` |
| 🟢 Added | `logs/security/2026-09/AUDIT_20260905_1503_pre-commit.md` |
| 🟡 Modified | `logs/security/LATEST_AUDIT.md` |
| 🟡 Modified | `logs/security/audit.jsonl` |
| 🟡 Modified | `proxy/Caddyfile` |
| 🟡 Modified | `proxy/README.md` |
| 🟡 Modified | `public/brand/README.md` |
| 🟡 Modified | `public/brand/logo.png` |
| 🟡 Modified | `public/brand/logo.svg` |
| 🟢 Added | `public/brand/source-screenshot.png` |
| 🟡 Modified | `run.sh` |
| 🟡 Modified | `scripts/README.md` |
| 🟢 Added | `scripts/brand-lock.ts` |
| 🟡 Modified | `scripts/generate-logo.ts` |
| 🟡 Modified | `scripts/generate-proxy.ts` |
| 🟡 Modified | `scripts/sync-ignores.ts` |
| 🟡 Modified | `scripts/trust-cert.ts` |
