...
- **Commit**: `1664a4e` (`1664a4e044bc163f38e0c6fd80bcd702237ee696`)
- **Timestamp**: `2026-09-03 19:17` (`2026-09-03T19:17:24+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `fix` | **Scope**: `ci`
- **Subject**: `consolidate pipeline to single-source-of-truth verify-gate, remove redundant steps`
...
```
fix(ci): consolidate pipeline to single-source-of-truth verify-gate, remove redundant steps

- Remove standalone gitleaks, tsc, bun test, and SBOM steps (already run inside verify-gate checks 3/4/12/27)
- Add GITHUB_STEP_SUMMARY success message on 27-gate pass
- Update workflows README with correct architecture diagram and trigger docs
- Identified 8 stale Dependabot remote branches for manual deletion
```
...
## 🗂️ Detailed File Changes (3 Files)
