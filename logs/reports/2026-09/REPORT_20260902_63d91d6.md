...
- **Commit**: `63d91d6` (`63d91d66b30a3099cfb37e3051b63f91d39718f1`)
- **Timestamp**: `2026-09-02 21:19` (`2026-09-02T21:19:21+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `fix` | **Scope**: `dev-dashboard`
- **Subject**: `resolve 32GB vs 16GB memory detection with virtualization awareness and eliminate hardcoded mock fallbacks`
...
```
fix(dev-dashboard): resolve 32GB vs 16GB memory detection with virtualization awareness and eliminate hardcoded mock fallbacks
```
...
| 🟡 Modified | `apps/src/dev-dashboard/src/backend/traffic-controller.ts` |
...
| 🟡 Modified | `apps/src/dev-dashboard/src/frontend/ui-overview-scripts.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/test/integration/host-vitals.test.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/test/unit/vitals-engine.test.ts` |
