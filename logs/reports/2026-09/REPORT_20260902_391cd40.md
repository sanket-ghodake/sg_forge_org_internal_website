...
- **Commit**: `391cd40` (`391cd404eea7e8a7ad76b9ee48f867a687948a11`)
- **Timestamp**: `2026-09-02 23:06` (`2026-09-02T23:06:16+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `portal`
- **Subject**: `unify dynamic member hydration, anchor docker project directory, and fix user team focus`
...
```
feat(portal): unify dynamic member hydration, anchor docker project directory, and fix user team focus
```
...
| Action | File Path |
| :--- | :--- |
| 🟡 Modified | `apps/src/auth/src/backend/telemetry.ts` |
