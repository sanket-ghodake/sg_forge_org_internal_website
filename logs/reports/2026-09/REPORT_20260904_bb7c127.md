...
- **Commit**: `bb7c127` (`bb7c1270cabf261c4e4e62b73cd4b1a2771ed91f`)
- **Timestamp**: `2026-09-04 20:45` (`2026-09-04T20:45:46+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `release`
- **Subject**: `production audit, container non-root hardening, and offline error resiliency`
...
```
feat(release): production audit, container non-root hardening, and offline error resiliency
```
...
- **Total Insertions (+)**: `+4904`
- **Total Deletions (-)**: `-792`
- **Affected Subsystems**: `auth`, `dev-dashboard`, `dev-hub`, `landing`, `portal`, `sdk`, `ui`, `docker-infra`, `app-template`, `billing`, `expenses`, `telemetry`, `toolchain`

---

## 🗂️ Detailed File Changes (65 Files)
...
| 🟡 Modified | `apps/src/auth/docker/Dockerfile` |
| 🟡 Modified | `apps/src/auth/src/server.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/docker/Dockerfile` |
| 🟡 Modified | `apps/src/dev-dashboard/src/backend/auth-session.ts` |
| 🟡 Modified | `apps/src/dev-hub/docker/Dockerfile` |
| 🟡 Modified | `apps/src/landing/docker/Dockerfile` |
| 🟡 Modified | `apps/src/landing/src/server.ts` |
| 🟢 Added | `apps/src/landing/test/integration/README.md` |
| 🟢 Added | `apps/src/landing/test/integration/offline-sw.test.ts` |
| 🟡 Modified | `apps/src/portal/docker/Dockerfile` |
| 🟡 Modified | `apps/src/portal/src/server.ts` |
| 🟢 Added | `apps/src/portal/test/e2e/README.md` |
| 🟢 Added | `apps/src/portal/test/e2e/outage-offline-cache.test.ts` |
| 🟢 Added | `apps/src/portal/test/integration/README.md` |
| 🟢 Added | `apps/src/portal/test/integration/offline-sw.test.ts` |
| 🟢 Added | `apps/src/sdk/src/backup.ts` |
| 🟢 Added | `apps/src/sdk/src/crypto.ts` |
| 🟡 Modified | `apps/src/sdk/src/error-handler.ts` |
| 🟡 Modified | `apps/src/sdk/src/index.ts` |
| 🟡 Modified | `apps/src/sdk/src/security-headers.ts` |
| 🟢 Added | `apps/src/sdk/src/service-worker.ts` |
| 🟢 Added | `apps/src/sdk/test/unit/README.md` |
| 🟢 Added | `apps/src/sdk/test/unit/backup-engine.test.ts` |
| 🟢 Added | `apps/src/sdk/test/unit/crypto-runtime.test.ts` |
| 🟡 Modified | `apps/src/sdk/test/unit/error-handler.test.ts` |
| 🟢 Added | `apps/src/sdk/test/unit/service-worker.test.ts` |
| 🟡 Modified | `apps/src/ui/src/error-page.ts` |
| 🟡 Modified | `apps/src/ui/src/state/head-script.ts` |
| 🟢 Added | `apps/test/security/offline-cache-security.test.ts` |
...
| 🟡 Modified | `forge-apps/app-template/docker/Dockerfile` |
| 🟡 Modified | `forge-apps/billing/docker/Dockerfile` |
| 🟡 Modified | `forge-apps/expenses/docker/Dockerfile` |
| 🟡 Modified | `forge-apps/telemetry/docker/Dockerfile` |
...
| 🟡 Modified | `proxy/errors/404.html` |
| 🟡 Modified | `proxy/errors/500.html` |
| 🟡 Modified | `proxy/errors/502.html` |
| 🟡 Modified | `proxy/errors/503.html` |
| 🟡 Modified | `run.bat` |
| 🟡 Modified | `run.sh` |
| 🟢 Added | `scripts/backup-databases.ts` |
| 🟡 Modified | `scripts/generate-error-pages.ts` |
| 🟡 Modified | `scripts/generate-proxy.ts` |
| 🟢 Added | `scripts/harden-storage.ts` |
| 🟡 Modified | `scripts/init-all-databases.ts` |
| 🟡 Modified | `scripts/sync-ignores.ts` |
| 🟡 Modified | `systemd/README.md` |
| 🟢 Added | `systemd/sg-db-backup.service` |
