...
- **Commit**: `76cf8ee` (`76cf8ee87365faf789cb322325863435e222a39e`)
- **Timestamp**: `2026-09-03 20:38` (`2026-09-03T20:38:35+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `ci`
- **Subject**: `switch CI/CD pipeline to manual workflow_dispatch trigger only`
...
```
feat(ci): switch CI/CD pipeline to manual workflow_dispatch trigger only
```
...
- **Total Insertions (+)**: `+5540`
- **Total Deletions (-)**: `-8`
- **Affected Subsystems**: `docker-infra`, `toolchain`
...
| 🟢 Added | `proxy/errors/404.html` |
| 🟢 Added | `proxy/errors/500.html` |
| 🟢 Added | `proxy/errors/502.html` |
| 🟢 Added | `proxy/errors/503.html` |
| 🟢 Added | `proxy/errors/README.md` |
| 🟡 Modified | `run.sh` |
| 🟡 Modified | `scripts/README.md` |
| 🟢 Added | `scripts/fallback-server.ts` |
| 🟢 Added | `scripts/generate-error-pages.ts` |
| 🟡 Modified | `scripts/generate-proxy.ts` |
| 🟢 Added | `scripts/test/fallback-server.test.ts` |
| 🟢 Added | `systemd/README.md` |
| 🟢 Added | `systemd/sg-forge-fallback.service` |
