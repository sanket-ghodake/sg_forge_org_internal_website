...
- **Commit**: `5c9ebe5` (`5c9ebe5f2c30f9d4915c26830c0e96c178e0618f`)
- **Timestamp**: `2026-09-04 13:20` (`2026-09-04T13:20:52+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `branding`
- **Subject**: `implement full-stack dynamic runtime identity from .env across UI, backend, DB, and DevOps`
...
```
feat(branding): implement full-stack dynamic runtime identity from .env across UI, backend, DB, and DevOps
```
...
- **Total Insertions (+)**: `+656`
- **Total Deletions (-)**: `-529`
- **Affected Subsystems**: `auth`, `dev-dashboard`, `dev-hub`, `portal`, `sdk`, `app-template`, `billing`, `expenses`, `telemetry`, `toolchain`
...
| 🟡 Modified | `apps/src/auth/src/backend/org-tree-service.ts` |
| 🟡 Modified | `apps/src/auth/src/backend/totp.ts` |
...
| 🟡 Modified | `apps/src/auth/test/unit/employee-controller.test.ts` |
| 🟡 Modified | `apps/src/auth/test/unit/totp.test.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/frontend/ui-modals.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/frontend/ui-renderer-ha.ts` |
...
| 🟡 Modified | `apps/src/portal/src/frontend/ui-renderer-inbox-widgets.ts` |
| 🟡 Modified | `apps/src/sdk/src/auth-guard.ts` |
| 🟡 Modified | `apps/src/sdk/src/branding.ts` |
| 🟡 Modified | `apps/src/sdk/src/error-handler.ts` |
| 🟡 Modified | `apps/src/sdk/test/unit/branding.test.ts` |
| 🟡 Modified | `apps/test/e2e/user-journey-auth-portal.test.ts` |
| 🟡 Modified | `apps/test/e2e/user-journey-direct-jump-sso.test.ts` |
| 🟡 Modified | `apps/test/integration/dynamic-rebranding.test.ts` |
...
| 🟡 Modified | `portables/bin/gitleaks` |
| 🟡 Modified | `portables/bin/knip` |
| 🟡 Modified | `portables/bin/osv-scanner` |
| 🟡 Modified | `portables/bin/trivy` |
| 🟡 Modified | `proxy/Caddyfile` |
| 🟡 Modified | `run.sh` |
| 🟡 Modified | `scripts/README.md` |
| 🟢 Added | `scripts/exec-watchdog.ts` |
| 🟡 Modified | `scripts/systemd/install-service.sh` |
| 🟡 Modified | `scripts/verify-all-tools.ts` |
