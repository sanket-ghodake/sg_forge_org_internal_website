...
- **Commit**: `1964501` (`19645018d5338265b6d88068be1dafc05a45da4c`)
- **Timestamp**: `2026-09-03 16:36` (`2026-09-03T16:36:35+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `orchestrator`
- **Subject**: `harden platform orchestrator, integrate ctop, fix compose path resolution, and secure dev auth`
...
```
feat(orchestrator): harden platform orchestrator, integrate ctop, fix compose path resolution, and secure dev auth
```
...
| 🟢 Added | `apps/test/unit/deploy-engine.test.ts` |
| 🟡 Modified | `deploy/README.md` |
| 🟢 Added | `deploy/deploy-prod.sh` |
| 🟢 Added | `deploy/rollback-prod.sh` |
| 🟢 Added | `deploy/status-prod.sh` |
...
| 🟢 Added | `portables/ctop/README.md` |
| 🟢 Added | `portables/ctop/ctop` |
| 🟡 Modified | `proxy/Caddyfile` |
| 🟡 Modified | `run.bat` |
| 🟡 Modified | `run.sh` |
| 🟡 Modified | `scripts/README.md` |
| 🟢 Added | `scripts/dev-runner.ts` |
