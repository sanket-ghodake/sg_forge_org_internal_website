...
- **Commit**: `692ffc6` (`692ffc6e861cd6a451b3a83e85319bb4e615ad76`)
- **Timestamp**: `2026-09-01 23:12` (`2026-09-01T23:12:09+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `portal`
- **Subject**: `redesign notifications and announcements hub for non-technical employees with live SQLite service`
...
```
feat(portal): redesign notifications and announcements hub for non-technical employees with live SQLite service
```
...
- **Total Insertions (+)**: `+1303`
- **Total Deletions (-)**: `-88`
- **Affected Subsystems**: `portal`

---

## 🗂️ Detailed File Changes (13 Files)

| Action | File Path |
| :--- | :--- |
| 🟢 Added | `apps/src/portal/src/backend/inbox-service.ts` |
| 🟡 Modified | `apps/src/portal/src/frontend/index.ts` |
| 🟡 Modified | `apps/src/portal/src/frontend/page-cards.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-inbox-scripts.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-renderer-inbox-widgets.ts` |
| 🟡 Modified | `apps/src/portal/src/frontend/ui-renderer-inbox.ts` |
| 🟡 Modified | `apps/src/portal/src/frontend/ui-scripts.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-styles-inbox.ts` |
...
| 🟢 Added | `apps/src/portal/test/unit/portal-inbox.test.ts` |
