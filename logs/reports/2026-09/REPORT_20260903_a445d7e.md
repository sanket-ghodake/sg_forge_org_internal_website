...
- **Commit**: `a445d7e` (`a445d7ebc7f2bb51949c81531387d2a0a198495a`)
- **Timestamp**: `2026-09-03 18:14` (`2026-09-03T18:14:45+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `ci`
- **Subject**: `consolidate github actions to single workflow and auto-stage sbom in hooks`
...
```
feat(ci): consolidate github actions to single workflow and auto-stage sbom in hooks
```
...
- **Total Insertions (+)**: `+210`
- **Total Deletions (-)**: `-211`
- **Affected Subsystems**: `toolchain`

---

## 🗂️ Detailed File Changes (15 Files)
...
| 🟢 Added | `logs/reports/2026-09/REPORT_20260903_463ec0d.md` |
...
| 🟡 Modified | `scripts/append-worklog.ts` |
