...
- **Commit**: `acce30f` (`acce30f16f08340e764290c577993d7dad72b751`)
- **Timestamp**: `2026-09-03 18:44` (`2026-09-03T18:44:27+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `fix` | **Scope**: `ci`
- **Subject**: `ensure single workflow by removing dependabot, fix test auth mode and db routing`
...
```
fix(ci): ensure single workflow by removing dependabot, fix test auth mode and db routing
```
...
## 🗂️ Detailed File Changes (5 Files)

| Action | File Path |
| :--- | :--- |
| 🔴 Deleted | `.github/dependabot.yml` |
| 🟡 Modified | `.github/workflows/pipeline.yml` |
| 🟡 Modified | `apps/src/dev-dashboard/src/backend/auth-session.ts` |
