...
- **Commit**: `b6ab999` (`b6ab999503c2abebe6225f97a83417b3081b677c`)
- **Timestamp**: `2026-09-02 04:17` (`2026-09-02T04:17:23+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `devcenter`
- **Subject**: `add forge app disabling with portal isolation and fix sse log stream keepalive`
...
```
feat(devcenter): add forge app disabling with portal isolation and fix sse log stream keepalive
```
...
- **Total Insertions (+)**: `+314`
- **Total Deletions (-)**: `-86`
- **Affected Subsystems**: `dev-dashboard`, `landing`, `portal`, `sdk`, `types`, `billing`, `expenses`, `telemetry`
...
| Action | File Path |
| :--- | :--- |
| 🟡 Modified | `apps/src/dev-dashboard/src/backend/apps-controller.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/backend/telemetry.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/db/db.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/frontend/ui-apps-modal-scripts.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/frontend/ui-apps-scripts.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/frontend/ui-log-scripts.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/frontend/ui-renderer-apps.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/frontend/ui-styles.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/test/integration/apps-lifecycle.test.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/test/unit/stream-resilience.test.ts` |
