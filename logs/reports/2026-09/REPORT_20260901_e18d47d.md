...
- **Commit**: `e18d47d` (`e18d47dd0e97457ba336771601ba6b633ae410ac`)
- **Timestamp**: `2026-09-01 21:29` (`2026-09-01T21:29:38+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `portal`
- **Subject**: `implement live SQLite Org Canvas with 5-level progressive depth loading, Meta Astryx SPA views, and browser telemetry`
...
```
feat(portal): implement live SQLite Org Canvas with 5-level progressive depth loading, Meta Astryx SPA views, and browser telemetry
```
...
- **Total Insertions (+)**: `+2819`
- **Total Deletions (-)**: `-212`
- **Affected Subsystems**: `portal`, `sdk`, `ui`
...
| Action | File Path |
| :--- | :--- |
| 🟢 Added | `apps/src/portal/src/backend/README.md` |
| 🟢 Added | `apps/src/portal/src/backend/org-tree-service.ts` |
| 🟡 Modified | `apps/src/portal/src/frontend/README.md` |
| 🟡 Modified | `apps/src/portal/src/frontend/index.ts` |
| 🟡 Modified | `apps/src/portal/src/frontend/layout-sidebar.ts` |
| 🟡 Modified | `apps/src/portal/src/frontend/page-cards.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-admin-apps.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-admin-audit.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-admin-members.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-admin-org.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-admin-scripts.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-admin-settings.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-canvas-scripts.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-command-palette.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-directory-scripts.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-modals.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-renderer-apps.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-renderer-canvas.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-renderer-directory.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-renderer-inbox.ts` |
| 🟢 Added | `apps/src/portal/src/frontend/ui-renderer-profile.ts` |
...
| 🟢 Added | `apps/src/portal/test/e2e/portal-spa-views.test.ts` |
| 🟢 Added | `apps/src/portal/test/unit/org-tree-service.test.ts` |
| 🟡 Modified | `apps/src/sdk/src/browser-bridge.ts` |
| 🟡 Modified | `apps/src/ui/src/styles/base.ts` |
| 🟡 Modified | `apps/src/ui/src/toast.ts` |
| 🟢 Added | `apps/src/ui/test/unit/toast-dropdown.test.ts` |
