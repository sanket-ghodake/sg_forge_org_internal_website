...
- **Commit**: `144192c` (`144192cf0b8f03162aad472bbcfdda5729e05877`)
- **Timestamp**: `2026-09-02 09:38` (`2026-09-02T09:38:17+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `auth`
- **Subject**: `centralize employee & org directory REST APIs and decouple microservices`
...
```
feat(auth): centralize employee & org directory REST APIs and decouple microservices
```
...
- **Total Insertions (+)**: `+8398`
- **Total Deletions (-)**: `-4198`
- **Affected Subsystems**: `auth`, `dev-dashboard`, `portal`, `sdk`, `toolchain`
...
| Action | File Path |
| :--- | :--- |
| 🟢 Added | `apps/src/auth/src/backend/api-org-handlers.ts` |
| 🟡 Modified | `apps/src/auth/src/backend/audit-logger.ts` |
| 🟢 Added | `apps/src/auth/src/backend/employee-controller.ts` |
| 🟢 Added | `apps/src/auth/src/backend/employee-import.ts` |
| 🟡 Modified | `apps/src/auth/src/backend/index.ts` |
| 🟢 Added | `apps/src/auth/src/backend/org-tree-service.ts` |
| 🟡 Modified | `apps/src/auth/src/server.ts` |
| 🟢 Added | `apps/src/auth/test/integration/org-api.test.ts` |
| 🟢 Added | `apps/src/auth/test/security/employee-rbac.test.ts` |
| 🟢 Added | `apps/src/auth/test/unit/employee-controller.test.ts` |
| 🟢 Added | `apps/src/dev-dashboard/src/backend/api-employee-handlers.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/src/backend/api-handlers.ts` |
| 🔴 Deleted | `apps/src/dev-dashboard/src/backend/employee-controller.ts` |
| 🔴 Deleted | `apps/src/dev-dashboard/src/backend/employee-import.ts` |
...
| 🟡 Modified | `apps/src/dev-dashboard/test/security/employee-security.test.ts` |
| 🟡 Modified | `apps/src/dev-dashboard/test/unit/employee-controller.test.ts` |
| 🔴 Deleted | `apps/src/portal/src/backend/org-tree-service.ts` |
| 🟡 Modified | `apps/src/portal/src/server.ts` |
| 🟡 Modified | `apps/src/portal/test/unit/org-tree-service.test.ts` |
