...
- **Commit**: `c73e82d` (`c73e82d21b7f03d43c1317e8f00254bef09c1841`)
- **Timestamp**: `2026-09-02 20:39` (`2026-09-02T20:39:55+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `feat` | **Scope**: `branding`
- **Subject**: `integrate custom coral-red SG Forge brand logo with dual-theme styling and 32px header sizing`
...
```
feat(branding): integrate custom coral-red SG Forge brand logo with dual-theme styling and 32px header sizing
```
...
- **Total Insertions (+)**: `+434`
- **Total Deletions (-)**: `-38`
- **Affected Subsystems**: `auth`, `dev-dashboard`, `portal`, `sdk`, `ui`, `toolchain`
...
| 🟡 Modified | `apps/src/portal/test/e2e/portal-spa-views.test.ts` |
| 🟡 Modified | `apps/src/sdk/src/branding.ts` |
| 🟡 Modified | `apps/src/sdk/src/browser-bridge.ts` |
| 🟢 Added | `apps/src/sdk/test/unit/browser-bridge.test.ts` |
...
| 🟢 Added | `public/brand/logo.svg` |
| 🟢 Added | `scripts/generate-logo.ts` |
