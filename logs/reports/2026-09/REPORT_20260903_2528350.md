...
- **Commit**: `2528350` (`2528350ee64a096d481d1a8ba9a3ea5b2371d964`)
- **Timestamp**: `2026-09-03 16:53` (`2026-09-03T16:53:50+05:30`)
- **Author**: `Sanket Ghodake`
- **Conventional Type**: `fix` | **Scope**: `security`
- **Subject**: `remediate 16 vulnerabilities across auth rbac, cookies, sql sandbox, and xss`
...
```
fix(security): remediate 16 vulnerabilities across auth rbac, cookies, sql sandbox, and xss
```
...
- **Total Insertions (+)**: `+3932`
- **Total Deletions (-)**: `-813`
- **Affected Subsystems**: `auth`, `dev-dashboard`, `portal`, `sdk`, `ui`

---

## 🗂️ Detailed File Changes (26 Files)
...
| 🟡 Modified | `apps/src/auth/test/contracts/jwks-contract.test.ts` |
| 🟡 Modified | `apps/src/auth/test/integration/org-api.test.ts` |
| 🟡 Modified | `apps/src/auth/test/security/employee-rbac.test.ts` |
...
| 🟢 Added | `apps/src/ui/src/sanitize.ts` |
| 🟢 Added | `apps/src/ui/test/unit/sanitize.test.ts` |
| 🟡 Modified | `deploy/deploy-prod.sh` |
